// To help us use arrays with real world problems we are going to simulate a used car
// dealer that has 50 cars in their inventory.
...
// The dealer can't recall the information for a car with an id of 33 on his lot. Help the dealer
 //find out which car has an id of 33 by logging the car's year, make, and model in
...
// The dealer needs the information on the last car in their inventory.
 //What is the make and model of the last car in the inventory?  Log the make and
...
// The accounting team needs all the years from every car
 //on the lot. Create a new array from the dealer data containing
...
// A buyer is interested in seeing only BMW and Audi cars
 //within the inventory.  Return an array that only contains BMW
